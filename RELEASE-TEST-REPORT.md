# LPOS v4.6.0 Release Test Report
...
- Full suite on the committed, sealed continuity candidate: `PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=src LPOS_EVALS_DIR=src/lpos_engine/evals pytest -p no:cacheprovider -q`, **426 passed, 0 failures**.
...
- Doctor reports LPOS 4.6.0 healthy with release integrity passed, 45 specialists, 29 Standing Operations, 70 benchmarks, and 22 schemas.
