...
- [4.2.1, Web Intelligence Capture Phase 1](/patch-notes/4-2-1-web-intelligence-phase-1.html)
- [4.2.0 security audit and SOC 2 readiness remediation](/patch-notes/4-2-0-soc2-readiness-remediation.html)
- [4.2.0, The SOC 2 Compliance Guild: codified controls, autonomous audit, staged remediation, SO-025](/patch-notes/4-2-0.html)
- [4.1.0, Skill Evolution, Hermes Project Dashboard, Connector Health Monitor, the User Guide wiki, SO-022/023/024](/patch-notes/4-1-0.html)
- [4.0.0, The integrated LPOS v4 baseline](/patch-notes/4-0-0.html)
